    ...
    while (session){
        ...
        switch (choice) {
            ...
            if(tranAccount == 1){
                ...
                System.out.println("Your transaction History in your Savings Account on " +date1 +" is as follows:");
                ...
                Date date1=new SimpleDateFormat("dd-MM-yyyy").parse(date);  
                System.out.println(date1);
                System.out.println("Your transaction History in your Current Account on " +date1 +" is as follows:");
                System.out.println("Balance:" + balance);
            }
                System.out.println("");
                break;
